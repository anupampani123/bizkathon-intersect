            ...
            <section class="section-shaped my-0">
                ...
                <div class="container shape-container d-flex">
                    <div class="col px-0">
                        <div class="row">
                            <div class="col-lg-6">
                                <h1 class="display-3  text-white">Investment for the uninvested
                                </h1>
                                <br>
                                <br>
                                <br>

                                <router-link to="/signup"><div class="btn-wrapper">
                                    <base-button tag="a"
                                                 href="#"
                                                 class="mb-3 mb-sm-0"
                                                 type="info"
                        ...
                        <div class="row row-grid">
                            <div class="col-lg-4">
                                <card class="border-0" hover shadow body-classes="py-5">
                                    ...
                                    <h6 class="text-primary text-uppercase">Not enough time?</h6>
                                    <p class="description mt-3">Centvest takes care of investing for your investments so that you can sit back and relax</p>
                                    <div>
                                        <badge type="primary" rounded>time</badge>
                            ...
                            <div class="col-lg-4">
                                <card class="border-0" hover shadow body-classes="py-5">
                                    ...
                                    <h6 class="text-success text-uppercase">Lack of Capital</h6>
                                    <p class="description mt-3">Centvest builds capital for you from every transaction you make</p>
                                    <div>
                            ...
                            <div class="col-lg-4">
                                <card class="border-0" hover shadow body-classes="py-5">
                                    ...
                                    <h6 class="text-warning text-uppercase">Feeling Overwhelmed</h6>
                                    <p class="description mt-3">Centvest walks you through investing from the beginning</p>
                                    <div>
